...
//
// A manifest-v10 run stores one reference-derived canonical subject profile,
// one canonical character master, one semantic board per animation,
// complete-pose recovery evidence, a complete-unit
